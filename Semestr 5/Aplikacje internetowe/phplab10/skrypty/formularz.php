...
if (filter_input(INPUT_POST, "submit")) {
    ...
    switch ($akcja) {
        case "Dodaj": dodajdoBD($bd);
            break;
        case "Pokaż": $zawartosc .= $bd->select("select * from klienci", ["Email", "Zamowienie"]);
            break;
        case "PHP": $zawartosc .= $bd->select("select Nazwisko,Zamowienie from klienci where Zamowienie regexp '^PHP'", ["Nazwisko", "Zamowienie"]);
            break;
        case "CPP": $zawartosc .= $bd->select("select Nazwisko,Zamowienie from klienci where Zamowienie regexp '^CPP'", ["Nazwisko", "Zamowienie"]);
            break;
        case "Java": $zawartosc .= $bd->select("select Nazwisko,Zamowienie from klienci where Zamowienie regexp '^Java'", ["Nazwisko", "Zamowienie"]);
            break;
        case "Statystyki": $zawartosc .= statystyki($bd);
            break;
    }
}
?>