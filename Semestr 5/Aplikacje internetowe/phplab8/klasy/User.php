...
class User {
    ...
    function saveDB($db){ 
        $sql = "INSERT INTO users (userName, fullName, email, passwd, status, date) VALUES ('".$this->userName."','".$this->fullName."','".$this->email."'"
    ...
    static function getAllUsersFromDB($bd){
        ...
        echo $bd->select("select userName,fullName,email,status,date from users", ["userName","fullName","email","status","date"]);
    }
}
