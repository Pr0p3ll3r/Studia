...
void MainWindow::on_wykres_liniowy_stateChanged(int arg1)
{
    ui->wykres_slupkowy->setChecked(false);
...
void MainWindow::on_wykres_slupkowy_stateChanged(int arg1)
{
    ui->wykres_liniowy->setChecked(false);
        liniowy = false;
}
